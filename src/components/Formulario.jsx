...
const Formulario = ({ cliente }) => {
  ...
  console.log('cliente', Object.keys(cliente));
  ...
  const handleSubmit = async (client) => {
    try {
      ...
      if(cliente.id) {
        ...
        await Helper.editarCliente(`${URL}/${cliente.id}`,client);
      } else {
        await Helper.crearCliente(URL, client);
      }
          ...
          return (
            <Form className="mt-10 ">
              ...
              <input
                ...
                className="mt-5 w-full bg-blue-800 p-3 text-white uppercase font-bold text-lg cursor-pointer hover:bg-blue-600 "
              />
            </Form>
          );
        }}
